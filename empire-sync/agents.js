...
// several of these repos didn't exist (unauthenticated GitHub API checks 404 on
// private repos — indistinguishable from "not found"). Verified with the actual
// GITHUB_TOKEN on this box: all of the below return 200 and are real, PRIVATE
// repos under RolandGasparyan. Full set restored + founders-kit/BOOKING-AI-AGENT added.
const ASSIGN = {
  ...
  'BOOKING-AI-AGENT':        { agent: 'Liam Turner (Operations Manager)', model: 'empire-strategist' },
